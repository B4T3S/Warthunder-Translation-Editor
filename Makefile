...
build: # Builds a ready to use .EXE
	.venv\Scripts\pyinstaller main.py -F -w -n War\ Thunder\ translation\ editor --add-data .venv\Lib\site-packages\nicegui:nicegui --add-data .venv\Lib\site-packages\webview:webview